...
$kerkimi = mysqli_real_escape_string($con, $_GET['titulli']); //merret titulli qe perdoruesit kane vendosur si input te search
$query = "SELECT * FROM movie WHERE title='$kerkimi'"; //query per te marre rezultate te ngjashme me inputin e perdoruesit
